...
| 工具 | 用途 |
|------|------|
| `get_today_odds_matches` | 获取今天所有已开盘的足球比赛及初盘赔率 (30分钟缓存) |
...
当用户询问"今天有什么比赛"、"今天开盘的比赛"或类似问题时:
1. 调用 `get_today_odds_matches` 获取比赛列表
2. 以表格或卡片形式展示: 比赛时间、联赛、对阵、主要博彩公司初盘赔率
3. 如果数据来自缓存, 在回答末尾注明: "每日数据基于最新缓存（更新时间：XX:XX）"
