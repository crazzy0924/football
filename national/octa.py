...
INSTRUCTION_S1 = """你是资深足球赛前分析师, 正在**独立**判断一场欧国联 League A 的比赛。
...
def build_evidence_s1(ms, model, elo, tables, stakes_all, rnd, home, away, date_str) -> str:
    ...
    L = []
    L.append("=== 比赛 ===")
    L.append("%s (%s) vs %s (%s)   欧国联 League A %s组   第 %d 轮 / 共 6 轮"
             % (home, h_cn, away, a_cn, grp or "?", rnd + 1))
    L.append("赛制: 4组x4队; 小组第一进1/4决赛; 垫底降级; 与2028欧洲杯附加赛资格挂钩。")
